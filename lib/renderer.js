...
const mathRenderer = text => text
    .replace(/\$\$([\s\S]+?)\$\$/g, (_, /** @type {String} */ expression) => {
        ...
        switch (renderer.mathRenderer) {
            ...
            case 'api-codecogs':
                return `<p style="text-align:center"><img src="https://latex.codecogs.com/svg.latex?${encodeURIComponent(expression)}"></p>`;
            ...
            case 'api-codecogs-preload':
                return `<p style="text-align:center"><!-- ${renderer.nonce} preload https://latex.codecogs.com/svg.latex?${encodeURIComponent(expression)} --></p>`;
        }
    })
    .replace(/\$([^\n]+?)\$/g, (_, /** @type {String} */ expression) => {
        ...
        switch (renderer.mathRenderer) {
            ...
            case 'api-codecogs':
                return `<img style="vertical-align:middle" src="https://latex.codecogs.com/svg.latex?${encodeURIComponent(expression)}">`;
            case 'api-zhihu-preload':
            ...
            case 'api-codecogs-preload':
                return `<span style="vertical-align:middle;display:inline-block"><!-- ${renderer.nonce} preload https://latex.codecogs.com/svg.latex?${encodeURIComponent(expression)} --></span>`;
